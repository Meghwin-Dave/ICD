                    ...
                    if (r.message) {
                        ...
                        let d = new frappe.ui.Dialog({
                            ...
                            fields: [
                                {
                                    ...
                                    fields: [
                                        ...
                                        { fieldtype: "Data", fieldname: "weight_unit", label: "Unit", in_list_view: 1, read_only: 1 },
                                        { fieldtype: "Int", fieldname: "no_of_packages", label: "Packages", in_list_view: 1, read_only: 1 }
                                    ],
                                    data: (manifest.containers || []).map(c => ({
                                        select: 0,
                            ...
                            primary_action(values) {
                                ...
                                // Fill first selected container in the form
                                let c = selected[0];
                                frm.set_value("container_no", c.container_no);
                                frm.set_value("m_bl_no", c.m_bl_no);
                                frm.set_value("size_ft", c.container_size);
                                frm.set_value("cargo_type", "General");
                                frm.set_value("freight_indicator", "FCL"); // default, adjust if needed
